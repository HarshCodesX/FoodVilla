        ...
        <div className="flex relative">
          ...
          <div className=" h-[100%]  w-[70%] mx-auto items-center gap-10 flex flex-col">
            <h1 className="text-[48px] text-white text-center font-bold">
              Order food & groceries. Discover <br /> best restaurants. Swiggy
              it!
            </h1>
            <div className="relative flex gap-4 w-[70%]">
            <i className=" fa-solid fa-location-dot absolute top-[22px] left-1 text-lg" style={{color: "#ff5200"}}></i>
              <input className="w-[60%] pl-6 h-[60px] rounded-lg p-4 bg-white" type="text" placeholder="Enter your delivery location" />
              <input
                className="w-[100%] h-[60px] rounded-lg p-4 bg-white"
                type="text"
            ...
            <div className="flex ">
              <Link to={"/restaurants"}>
                <img className="h-[280px] w-[260px]" src={c1} alt="" />
              </Link>
              <img
                onClick={() => {
                  navigate("/instamart");
                }}
                className="h-[280px] w-[260px]"
                src={c2}
                alt=""
              />
              <img className="h-[280px] w-[260px]" src={c3} alt="" />
              <img className="h-[280px] w-[260px]" src={c4} alt="" />
            </div>
          </div>
